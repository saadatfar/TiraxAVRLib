...
#ifndef _TIRAX_DS18B20M_INCLUDED_
#define _TIRAX_DS18B20M_INCLUDED_
...
int ds18b20_temperature_phase1(unsigned char *addr);
float ds18b20_temperature_phase2(unsigned char *addr,unsigned char resolution);
#pragma used-
